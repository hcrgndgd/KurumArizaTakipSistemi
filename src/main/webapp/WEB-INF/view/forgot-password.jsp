...
<head>
  ...
  <title><spring:message code="auth.forgot.title"/></title>
  <style>
    :root {
      --bg: #f4f1ea;
...
<main class="shell">
  <div class="card">
    ...
    <h2><spring:message code="auth.forgot.title"/></h2>
    <p><spring:message code="auth.forgot.subtitle"/></p>
    ...
    <form method="post" action="${pageContext.request.contextPath}/auth/forgot-password">
      ...
      <button type="submit">
        <spring:message code="auth.forgot.button"/>
      </button>
    </form>
