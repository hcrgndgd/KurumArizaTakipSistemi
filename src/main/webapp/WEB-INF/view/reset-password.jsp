...
<head>
    ...
    <title><spring:message code="auth.reset.title"/></title>
    <style>
        :root {
            --bg: #f4f1ea;
        ...
        * { box-sizing: border-box; }
        ...
        .meta { margin-top: 20px; color: var(--muted); line-height: 1.7; }
...
<main class="shell">
    <div class="card">
        ...
        <h2><spring:message code="auth.reset.title"/></h2>
        <p><spring:message code="auth.reset.subtitle"/></p>
        ...
        <form method="post" action="${pageContext.request.contextPath}/auth/reset-password">
            ...
            <div class="field">
                <label for="password"><spring:message code="auth.reset.password"/></label>
                <input id="password" name="password" type="password"
                       placeholder="••••••••" required>
            </div>

            <div class="field">
                <label for="confirmPassword"><spring:message code="auth.reset.confirm"/></label>
                <input id="confirmPassword" name="confirmPassword" type="password"
                       placeholder="••••••••" required>
            </div>

            <button type="submit">
                <spring:message code="auth.reset.button"/>
            </button>
        </form>

        <div class="meta">
            <a href="${pageContext.request.contextPath}/login">
                ← <spring:message code="auth.forgot.back"/>
            </a>
        </div>
    </div>
</main>
