...
<div class="container">
    <div class="card">
        <div class="header">
            <h1>📝 Yeni Ticket</h1>
            <p>Sorununuzu açıklayarak yeni bir ticket oluşturun</p>
        </div>
        ...
        <div class="info">
            ℹ️ Kategori başlık ve açıklamadan otomatik olarak tahmin edilebilir.
        </div>
        ...
        <form method="post" action="${pageContext.request.contextPath}/user/tickets">
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" maxlength="200" required 
                       placeholder="Sorununuzun kısaca açıklaması" value="${title}"/>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" maxlength="2000" required 
                          placeholder="Sorununuzun detaylı açıklaması">${description}</textarea>
            </div>

            <div class="form-actions">
                <button type="submit">✓ Gönder</button>
                <a href="${pageContext.request.contextPath}/user/tickets" class="btn btn-secondary">← İptal</a>
            </div>
        </form>
    </div>
</div>
